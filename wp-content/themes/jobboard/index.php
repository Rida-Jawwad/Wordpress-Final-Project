      ...
      <div class="container">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-6 col-lg-3 col-md-6 text-center">
            <img src="<?php echo get_template_directory_uri(); ?>/images/logo_mailchimp.svg" alt="Image" class="img-fluid logo-1">
          </div>
          <div class="col-6 col-lg-3 col-md-6 text-center">
            <img src="<?php echo get_template_directory_uri(); ?>/images/logo_paypal.svg" alt="Image" class="img-fluid logo-2">
          </div>
          <div class="col-6 col-lg-3 col-md-6 text-center">
            <img src="<?php echo get_template_directory_uri(); ?>/images/logo_stripe.svg" alt="Image" class="img-fluid logo-3">
          </div>
          <div class="col-6 col-lg-3 col-md-6 text-center">
            <img src="<?php echo get_template_directory_uri(); ?>/images/logo_visa.svg" alt="Image" class="img-fluid logo-4">
          </div>

          <div class="col-6 col-lg-3 col-md-6 text-center">
            <img src="<?php echo get_template_directory_uri(); ?>/images/logo_apple.svg" alt="Image" class="img-fluid logo-5">
          </div>
          <div class="col-6 col-lg-3 col-md-6 text-center">
            <img src="<?php echo get_template_directory_uri(); ?>/images/logo_tinder.svg" alt="Image" class="img-fluid logo-6">
          </div>
          <div class="col-6 col-lg-3 col-md-6 text-center">
            <img src="<?php echo get_template_directory_uri(); ?>/images/logo_sony.svg" alt="Image" class="img-fluid logo-7">
          </div>
          <div class="col-6 col-lg-3 col-md-6 text-center">
            <img src="<?php echo get_template_directory_uri(); ?>/images/logo_airbnb.svg" alt="Image" class="img-fluid logo-8">
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="owl-carousel single-carousel">
          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-lg-6 align-self-end text-center text-lg-right">
                <img src="<?php echo get_template_directory_uri(); ?>/images/person_transparent_2.png" alt="Image" class="img-fluid mb-0">
              </div>
            </div>
          </div>
          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-lg-6 align-self-end text-center text-lg-right">
                <img src="<?php echo get_template_directory_uri(); ?>/images/person_transparent.png" alt="Image" class="img-fluid mb-0">
              </div>
            </div>
          </div>
